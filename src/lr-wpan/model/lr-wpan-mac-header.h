...
public:
  ...
  uint8_t GetNextPacket (void) const ;  // add by ieong
  ...
  void SetNextPacket (uint8_t control); // add by ieong
  //void SetNextPacket (uint16_t control); // add by ieong   // for 512
...
private:
  ...
  uint8_t m_nextpacket;                // add by ieong
